<%-- 
    Document   : signUp
    Created on : 19/11/2014, 00:00:12
    Author     : Mauri
--%>
...
<html>
    ...
    if ( request.getParameter("campo_controle") != null ) {
        ...
        if(nome == null || sobrenome == null || username == null || email == null 
         || senha == null || pais == "" || checkbox == null){
        %> Preencha todos os campos e assinale a checkbox<%
        } else{
...
<option value="ZW">Zimbabwe</option>
                    ...
                    <tr>
                        <td><input type="checkbox" name="checkbox" />Li e aceito termos de uso
                    </tr>
                </table>
